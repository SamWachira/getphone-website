...
export default function BrandsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <PageHero
        eyebrow="OUR BRANDS"
        title="Trusted OEM Partners"
        description="We distribute devices from world-class smartphone manufacturers, ensuring authentic hardware reaches every corner of Africa."
        stats={[
          {
            icon: (
      ...
      {/* ═══ OPPO SECTION ═══ */}
      <section className="py-20 md:py-28 bg-white w-full border-b border-gray-100 overflow-hidden relative">
        ...
        <div className="section-container px-5 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            {/* Right Graphics — with gradient glow */}
      ...
      <section className="py-20 md:py-28 bg-[#FAFBFD] w-full border-b border-gray-100 overflow-hidden relative">
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-48 h-48 opacity-[0.04] pointer-events-none">
          <svg width="192" height="192" viewBox="0 0 192 192" fill="none">
            <defs>
              <pattern id="dots-zte" width="16" height="16" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1.5" fill="#224167" />
              </pattern>
            </defs>
            <rect width="192" height="192" fill="url(#dots-zte)" />
          </svg>
        </div>
        ...
        <div className="section-container px-5 lg:px-8">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
            ...
            {/* Left Graphics — with gradient glow */}
            <div className="w-full lg:w-7/12 relative h-[380px] md:h-[480px] animate-fade-in-up delay-100">
              {/* Gradient glow behind the showcase */}
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      ...
      <section className="py-20 md:py-28 bg-white w-full border-b border-gray-100 relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#25a93e]/[0.03] rounded-full blur-3xl pointer-events-none" />

        <div className="section-container px-5 lg:px-8">
          <div className="max-w-3xl mb-16 mx-auto text-center animate-fade-in-up">
            <span className="text-xs font-bold text-[#25a93e] tracking-widest uppercase block mb-3">
              VALUE PROPOSITION
            </span>
